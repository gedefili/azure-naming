...
# Path: bash/naming/publish-provider-acr.sh
...
#
# Usage:
#   bash /workspaces/tools-iac/bash/naming/publish-provider-acr.sh
#   bash /workspaces/tools-iac/bash/naming/publish-provider-acr.sh --version 1.0.0
#   bash /workspaces/tools-iac/bash/naming/publish-provider-acr.sh --skip-build
#
# Prerequisites:
...
PROVIDER_SOURCE="/workspaces/azure-naming/terraform-provider-sanmar"
GO_MIN_VERSION="1.22"
...
show_usage() {
  cat <<'USAGE'
Usage: publish-provider-acr.sh [OPTIONS]
